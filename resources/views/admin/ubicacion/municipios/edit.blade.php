    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Editar Municipio</h1>
            ...
            <form method="POST" action="{{ route('admin.ubicacion.municipios.update', $municipio) }}">
                @csrf @method('PUT')
                    ...
                    <select id="id_provincia" 
                        ...
                        @foreach($provincias as $provincia)
                            <option value="{{ $provincia->id_provincia }}" 
                                    {{ old('id_provincia', $municipio->id_provincia) == $provincia->id_provincia ? 'selected' : '' }}>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i>Actualizar Municipio
                    </button>
                </div>
            </form>
        </div>
