    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Nuevo Asiento</h1>
            ...
            <form method="POST" action="{{ route('admin.ubicacion.asientos.store') }}">
                @csrf
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i>Guardar Asiento
                    </button>
                </div>
            </form>
        </div>
