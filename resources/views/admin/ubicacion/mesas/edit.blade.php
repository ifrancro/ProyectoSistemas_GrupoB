...
<div class="p-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <form method="POST" action="{{ route('admin.ubicacion.mesas.update', $mesa) }}">
                @csrf @method('PUT')
                    ...
                    <select id="id_recinto" 
                        ...
                        @foreach($recintos as $recinto)
                            <option value="{{ $recinto->id_recinto }}" 
                                    {{ old('id_recinto', $mesa->id_recinto) == $recinto->id_recinto ? 'selected' : '' }}>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i>Actualizar Mesa
                    </button>
                </div>
            </form>
        </div>
