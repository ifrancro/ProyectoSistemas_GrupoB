...
<div class="p-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.ubicacion.mesas.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
        ...
        <table class="w-full">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jurados</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $mesa->id_mesa }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $mesa->numero }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $mesa->recinto->nombre }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {{ $mesa->recinto->asiento->municipio->nombre }} - {{ $mesa->recinto->asiento->municipio->provincia->nombre }} - {{ $mesa->recinto->asiento->municipio->provincia->departamento->nombre }}
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            <a href="{{ route('admin.ubicacion.mesas.show', $mesa) }}" 
                            ...
                            <form action="{{ route('admin.ubicacion.mesas.destroy', $mesa) }}" 
