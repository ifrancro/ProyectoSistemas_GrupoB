    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Nuevo Recinto</h1>
            ...
            <form method="POST" action="{{ route('admin.ubicacion.recintos.store') }}">
                @csrf
                    ...
                    <select id="id_asiento" 
                        ...
                        @foreach($asientos as $asiento)
                            <option value="{{ $asiento->id_asiento }}" 
                                    {{ old('id_asiento') == $asiento->id_asiento ? 'selected' : '' }}>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i>Guardar Recinto
                    </button>
                </div>
            </form>
        </div>
